...
server: all $(ALL_SERVER_LIBRARIES)
	$(CC) $(CFLAGS) $(ALL_SERVER_HEADERS_DIRECTORY_FLAGS) -o $(SERVER_EXECUTION_FILE_NAME) $(ALL_SERVER_LIBRARIES_DIRECTORY_FLAGS) $(LDFLAG_START) $(ALL_SERVER_ARCHIVE_NAMES_FLAGS) -ldotenv $(LDFLAG_END)


client: all $(ALL_SERVER_LIBRARIES)
	$(CC) $(CFLAGS) $(ALL_CLIENT_HEADERS_DIRECTORY_FLAGS) -o $(CLIENT_EXECUTION_FILE_NAME) $(ALL_CLIENT_LIBRARIES_LIBRARIES_FLAGS) $(LDFLAG_START) $(ALL_CLIENT_ARCHIVE_NAMES_FLAGS) -ldotenv $(LDFLAG_END)
